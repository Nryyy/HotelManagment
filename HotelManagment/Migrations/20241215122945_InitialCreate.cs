        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StayHistories_Guests_GuestId",
                        column: x => x.GuestId,
                        principalTable: "Guests",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BookingPayments_PaymentMethods_PaymentMethodId",
                        column: x => x.PaymentMethodId,
                        principalTable: "PaymentMethods",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BookingPayments_PaymentStatuses_PaymentStatusId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BookingStatusHistories_Employees_ChangedByEmployeeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookingPayments_PaymentStatusId",
                table: "BookingPayments",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookingStatusHistories_ChangedByEmployeeId",
                table: "BookingStatusHistories",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StayHistories_GuestId",
                table: "StayHistories",
                column: "GuestId");

            migrationBuilder.CreateIndex(
                name: "IX_StayHistories_RoomId",
                table: "StayHistories",
                column: "RoomId");
        }
